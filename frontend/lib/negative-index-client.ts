...
export type NegativeIndexStatus =
  "queued" | "running" | "succeeded" | "partial" | "limit_reached" | "failed";

export type NegativeIndexStage =
  "preparing" | "searching" | "classifying" | "verifying" | "clustering" | "scoring" | "completed";
...
export type NegativeEventStatus =
  "suspected" | "reported" | "confirmed" | "disputed" | "resolved" | "retracted" | "false_positive";
