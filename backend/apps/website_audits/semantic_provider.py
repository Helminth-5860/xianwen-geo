...
SEMANTIC_ADAPTER_VERSION = "deepseek-website-audit-v1"
SEMANTIC_PROMPT_VERSION = "website-geo-semantic-audit-v1"
...
严格 JSON 结构：
{
  ...
  "entity_assessment": {
    ...
    "recognized_entities": [
      {"name":"实体名","type":"organization|brand|product|service|other","evidence_urls":["输入中的URL"]}
    ],
    "conflicts": [
      {"description":"冲突描述","evidence_urls":["输入中的URL"]}
    ]
  },
  "content_findings": [
    {
  ...
  "topic_gaps": [
    {
      ...
      "evidence_urls":["用于说明当前覆盖不足的输入URL；没有则空数组"]
    }
  ],
  "citeable_passages": [
    {
