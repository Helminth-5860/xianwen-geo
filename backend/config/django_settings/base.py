...
GEO_DETECTION_CONCURRENCY_RECHECK_SECONDS = positive_env_int(
    "GEO_DETECTION_CONCURRENCY_RECHECK_SECONDS", 4
)
if GEO_DETECTION_CONCURRENCY_RECHECK_SECONDS > 30:
    raise ImproperlyConfigured("GEO_DETECTION_CONCURRENCY_RECHECK_SECONDS must not exceed 30.")
...
CELERY_TASK_ROUTES = {
    ...
    "negative_index.execute": {"queue": "web_fetch"},
