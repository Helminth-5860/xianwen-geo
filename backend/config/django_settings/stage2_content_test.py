...
ARTICLE_IDEMPOTENCY_HMAC_KEY = os.environ["ARTICLE_IDEMPOTENCY_HMAC_KEY"]
REPORT_SHARE_HMAC_KEY = os.environ["REPORT_SHARE_HMAC_KEY"]
...
CACHES = {
    "default": {
        ...
        "LOCATION": "xianwen-stage2-content-test",
    }
}
