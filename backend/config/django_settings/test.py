...
ARTICLE_IDEMPOTENCY_HMAC_KEY = "test-only-article-idempotency-key-never-use-in-deployment"
REPORT_SHARE_HMAC_KEY = "test-only-report-share-hmac-key-never-use-in-deployment"
...
VIDEO_IDEMPOTENCY_HMAC_KEY = "test-only-video-idempotency-key-never-use-in-deployment"
