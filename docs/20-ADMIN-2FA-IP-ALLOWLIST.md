...
`customer.assignment.change`、套餐及套餐版本日常管理、套餐申请联系/关闭和订阅生命周期动作不在短信集合内；它们按冻结 RiskPolicy 执行 confirm/password、current-password、乐观版本检查及操作记录。系统没有审批批准端或等待队列。
